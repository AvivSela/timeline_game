...
export interface IDatabaseService {
  ...
  updateGameState(roomCode: string, state: any): Promise<Game>;
  ...
  updatePlayerHand(playerId: string, handCards: number[]): Promise<Player>;
  ...
  getTimelineForGame(roomCode: string): Promise<TimelineCard[]>;
