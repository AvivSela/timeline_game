      ...
      <Container maxWidth="2xl" className="py-12">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Challenge your knowledge of history with this educational card game. 
            Arrange historical events in chronological order and compete with friends!
          </p>
        </div>
          ...
          <div className="card">
            <div className="card-body text-center">
              ...
              <p className="text-gray-600 mb-6">
                ...
                You'll get a unique room code to share.
              </p>
              <Button
        ...
        <div className="mt-12 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-sm text-gray-600">
            ...
            <div>
              ...
              <p>Arrange historical events in order</p>
            </div>
          </div>
        </div>
      </Container>
